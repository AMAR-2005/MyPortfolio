      ...
      <motion.div variants={container} initial="hidden" animate="show">
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="max-w-3xl pt-6">
            ...
            <motion.h1
              variants={item}
              className="pb-6 text-4xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100 sm:text-5xl md:text-6xl"
            >
              Hi, I'm{' '}
          ...
          <motion.div
            variants={item}
            className="h-content sm:h-content-sm flex flex-col justify-around"
          >
        ...
        <motion.hr variants={item} className="border-gray-200 dark:border-gray-700" />
